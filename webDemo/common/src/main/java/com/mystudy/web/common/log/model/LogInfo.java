 ...
 * Function：日志信息model
 */
public class LogInfo extends AbstractLogInfo{
    ...
    public String toString() {
        ...
        stringBuilder.append(getAppName()).append(TAB);
        stringBuilder.append(getServiceName()).append(TAB);
        stringBuilder.append(getElapsedTime()).append(TAB);
        stringBuilder.append(getLogTime()).append(TAB);
        stringBuilder.append(getLogType()).append(ENTER);
